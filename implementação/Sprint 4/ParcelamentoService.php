...
class ParcelamentoService
{
    ...
    public static function cadastrarParcelamento($idAr, $dadosParcelamento)
    {
        ...
        if (!empty($arrayDecretoPortaria)) {
            foreach ($arrayDecretoPortaria as $decretoPortaria) {

                $numeroPublicacao = $decretoPortaria['numero_publicacao'];
                $dataDecretoPortaria = $decretoPortaria['data_decreto_portaria'];

                DecretoPortariaService::criarDecretoPortaria($numeroPublicacao, $idParcelamento, $dataDecretoPortaria);
    ...
    public static function editarParcelamento($dadosParcelamento)
    {
        ...
        if (!empty($arrayDecretoPortaria)) {
            foreach ($arrayDecretoPortaria as $decretoPortaria) {
                ...
                DecretoPortariaService::criarDecretoPortaria($numeroPublicacao, $dadosParcelamento['id_parcelamento'], $dataDecretoPortaria);
            }
        }
